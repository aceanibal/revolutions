...
Outputs:
- cache/rsi_year_asset_grid_managed.csv
- cache/rsi_year_asset_best.csv
- cache/rsi_year_global_pattern.csv
...
REPORT_MD = os.path.join(_PROJECT_ROOT, "FINAL_RSI_ENTRY_ADAPTIVE_PATTERN.md")
