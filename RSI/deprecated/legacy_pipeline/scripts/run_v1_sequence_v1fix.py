...
def main() -> None:
    ap = argparse.ArgumentParser(description="Run v1fix massive-chunk sequence and package all artifacts.")
    ...
    ap.add_argument("--rsi-window", type=int, default=20, help="RSI period on 4h (Wilder window).")
    ...
    config = {
        ...
        "variant": "v1fix_two_stage_mfe_samebar_lock",
    }
